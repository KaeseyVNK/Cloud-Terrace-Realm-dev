...
namespace FischlWorks_FogWar
{
    ...
    public class csFogWar : MonoBehaviour
    {
        ...
        private void ForceUpdateFog()
        {
            ...
            if (fogPlaneTextureTargetPixels != null && fogPlaneTextureBufferPixels != null)
            {
                System.Array.Copy(fogPlaneTextureTargetPixels, fogPlaneTextureBufferPixels, fogPlaneTextureTargetPixels.Length);
        ...
        private void RemoveInvalidFogRevealers()
        {
            ...
            {
                if (fogRevealers[i] == null || fogRevealers[i]._RevealerTransform == null)
                {
        ...
        private void EnsureFogTexturePixelBuffers()
        {
            int pixelCount = levelDimensionX * levelDimensionY;

            if (fogPlaneTextureTargetPixels == null || fogPlaneTextureTargetPixels.Length != pixelCount)
            {
                fogPlaneTextureTargetPixels = new Color[pixelCount];
            }

            if (fogPlaneTextureBufferPixels == null || fogPlaneTextureBufferPixels.Length != pixelCount)
            {
                fogPlaneTextureBufferPixels = new Color[pixelCount];
            }
        }
        ...
        public bool CheckVisibility(Vector3 worldCoordinates, int additionalRadius)
        {
            ...
            if (shadowcaster == null ||
                ...
                CheckLevelGridRange(levelCoordinates) == false)
            {
                return false;
            }
