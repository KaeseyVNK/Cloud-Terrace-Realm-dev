...
public class EnemyShieldKnightController : EnemyUnitController
{
    [Header("Shield Block")]
    [SerializeField, Range(0f, 1f)] private float _blockChance = 0.3f;
    [SerializeField, Range(0f, 180f)] private float _frontBlockAngle = 120f;
    [SerializeField] private float _blockCooldown = 1.1f;
    [SerializeField] private float _blockVisualDuration = 0.9f;
    [SerializeField] private float _knockbackRange = 3f;
    [SerializeField] private float _knockbackDistance = 1.1f;
    [SerializeField] private float _knockbackDuration = 0.18f;

    private float _nextBlockTime;
    private float _blockVisualTimer;

    public EnemyShieldKnightController()
    {
        faction = UnitFaction.Enemy;
        unitName = "Enemy Shield Knight";
    }

    protected override void Start()
    {
        base.Start();
        unitName = string.IsNullOrEmpty(unitName) || unitName == "Enemy Soldier" ? "Enemy Shield Knight" : unitName;
    }
